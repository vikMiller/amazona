...
# React Project - ECommerce App (Amazon Clone) [2023]
...
- 👉 Render : [https://amazona-app-mdgq.onrender.com](https://amazona-app-mdgq.onrender.com)
...
```
$ git clone git@github.com:vikMiller/amazona.git
$ cd amazona
```
